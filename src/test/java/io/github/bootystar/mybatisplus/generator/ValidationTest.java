...
public class ValidationTest {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 测试ControllerConfig
            io.github.bootystar.mybatisplus.generator.config.ControllerConfig controllerConfig = 
                io.github.bootystar.mybatisplus.generator.config.ControllerConfig.builder()
                    .enableRestStyle()
                    .enableHyphenStyle()
                    .baseUrl("/api/v1")
                    .build();
            ...
            // 测试ServiceConfig
            io.github.bootystar.mybatisplus.generator.config.ServiceConfig serviceConfig = 
                io.github.bootystar.mybatisplus.generator.config.ServiceConfig.builder()
            ...
            // 测试MapperConfig
            io.github.bootystar.mybatisplus.generator.config.MapperConfig mapperConfig = 
                io.github.bootystar.mybatisplus.generator.config.MapperConfig.builder()
            ...
            // 测试EntityConfig
            io.github.bootystar.mybatisplus.generator.config.EntityConfig entityConfig = 
                io.github.bootystar.mybatisplus.generator.config.EntityConfig.builder()
                    .enableLombok()
            ...
            // 测试VoConfig
            io.github.bootystar.mybatisplus.generator.config.VoConfig voConfig = 
                io.github.bootystar.mybatisplus.generator.config.VoConfig.builder()
                    .package4VO("vo")
                    .enableFileOverride()
                    .build();
            ...
            // 测试OutputFile枚举
            io.github.bootystar.mybatisplus.generator.config.OutputFile outputFile = 
                io.github.bootystar.mybatisplus.generator.config.OutputFile.dto_insert;
