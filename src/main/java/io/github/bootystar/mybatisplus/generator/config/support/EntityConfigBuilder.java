...
public class EntityConfigBuilder implements IConfigBuilder<EntityConfig> {
    ...
    private final EntityConfig entity = new EntityConfig();
     ...
     * <p>当开启了 {@link EntityConfig#serialVersionUID} 时,会增加 {@link java.io.Serial} 注解在此字段上</p>
     *
     * @return this
     * @since 3.5.11
     */
     ...
     * @since 3.5.0
     */
    public EntityConfigBuilder disableLombok() {
     ...
     * @since 3.5.6
     */
    public EntityConfigBuilder kotlinTemplatePath(String template) {
